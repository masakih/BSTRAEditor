...
- (void)setActiveBlueStartColor:(NSColor *)color
{
	...
	if(color == [[self activeBlueColors] objectAtIndex:0]) return;
...
{
	NSAssert(color, @"color is nil!");
	if(color == [[self activeBlueColors] objectAtIndex:1]) return;
...
{
	NSAssert(color, @"color is nil!");
	if(color == [[self activeGraphiteColors] objectAtIndex:0]) return;
...
{
	NSAssert(color, @"color is nil!");
	if(color == [[self activeGraphiteColors] objectAtIndex:1]) return;
...
{
	NSAssert(color, @"color is nil!");
	if(color == [[self inactiveColors] objectAtIndex:0]) return;
...
{
	NSAssert(color, @"color is nil!");
	if(color == [[self inactiveColors] objectAtIndex:1]) return;
...
{
	if(color == m_infoTextColor) return;
